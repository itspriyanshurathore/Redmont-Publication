...
<section className="relative overflow-hidden bg-[#f8fafc] py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-4xl text-[15px] leading-8 text-[#64748b]">
            Redmont Publications welcomes inquiries from researchers,
            academicians, scholars, institutions, conference organizers,
            authors, and academic professionals seeking publishing,
            editorial, research, or scholarly communication support.
          </p>
        </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#64748b]">
                      editor@redmontpublications.com
                    </p>
  ...
  <p className="mt-4 text-[15px] leading-8 text-[#64748b]">
    We encourage professional and respectful communication
    for all academic, editorial, and publication-related
    discussions.
  </p>
      ...
      />
        ...
        <div className="mt-10 rounded-2xl border border-red-100 bg-red-50 p-8">
          ...
          <p className="mt-4 text-[15px] leading-8 text-[#475569]">
            Redmont Publications provides academic publishing,
            editorial, and research support services intended for
            educational and scholarly purposes. Researchers and authors
            are encouraged to independently verify institutional and
  ...
  <div className="flex flex-col items-center text-center">
    ...
    <div className="mt-8 flex flex-wrap justify-center gap-4">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="group flex items-center gap-3 rounded-xl border border-[#0077B5]/20 bg-[#0077B5]/5 px-5 py-3 transition-all duration-300 hover:bg-[#0077B5]"
      >
